...
| Datei / Ordner         | Zweck                                             |
|------------------------|---------------------------------------------------|
| `index.html`           | Inhalt der App (`<main class="app">` ist leer)    |
| `css/style.css`        | Grundstil, Safe-Areas, Dark Mode                  |
| `js/app.js`            | Registriert den Service Worker (Offline-Funktion) |
